...
print('Prediction: Sport Basketball Volleyball Soccer:')
print(getPrediction('Sport Basketball Volleyball Soccer', 10))
print('\nPrediction: What is the capital city of Australia?:')
print(getPrediction('What is the capital city of Australia?', 10))
print('\nPrediction: How many goals Vancouver score last year?:')
